...
- Old deep links like `https://mkweli.tech/Mkweli_v1.0.8.apk` will break after cutover (expected). Current APK: `https://aml.mkweli.tech/Mkweli_v1.0.12.apk` or GitHub Release `https://github.com/gilbertbouic/MkweliMobile/releases/download/v1.0.12/Mkweli_v1.0.12.apk`.
